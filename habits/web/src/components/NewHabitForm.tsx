    ...
    return (
        <form onSubmit={createNewHabit} className="w-full flex flex-col mt-6">
            ...
            <input
                ...
                className="px-7 py-4 rounded-lg mt-3 bg-zinc-800 text-white placeholder:text-zinc-400"
                autoFocus
                value={title}
            ...
            <button type="submit" className="mt-6 rounded-lg px-7 py-4 flex items-center  gap-3 font-semibold bg-green-600 hover:bg-green-500">
